...
description: DaVinci Resolve MCP server skill for AI-assisted video editing, color grading, Fusion compositions, timeline management, rendering, and media pool operations. Use when the user asks about editing video, color grading, managing timelines, rendering, or any DaVinci Resolve workflow.
---
